...
class StateManager {
  constructor() {
    ...
    this.state = {
      tasks: [
        { text: "Practice yoga", completed: false },
        { text: "Write a poem about a squirrel", completed: true },
        { text: "Take a photo of a cat napping", completed: false },
        { text: "Write a song about a pineapple", completed: false },
      ],
